...
# append well number onto barcodes 
...
# check RNA barcodes are in filtered metadata 
setequal(cell_meta$barcode, colnames(rna_raw))
setdiff(cell_meta$barcode, colnames(rna_raw) ) %>% length 
...
# process RNA data with vst residual pca. 
s = NormalizeData(s) %>%
...
#   [1] Rtsne_0.15            colorspace_2.0-0      deldir_0.2-10         ellipsis_0.3.1        rprojroot_2.0.2       mclust_5.4.7          fs_1.5.0             
# [8] rstudioapi_0.13       spatstat.data_2.1-0   farver_2.0.3          leiden_0.3.7          listenv_0.8.0         bit64_4.0.5           ggrepel_0.9.1        
# [15] RSpectra_0.16-0       lubridate_1.7.9.2     xml2_1.3.2            codetools_0.2-18      splines_4.0.5         polyclip_1.10-0       jsonlite_1.7.2       
# [22] broom_0.7.5           ica_1.0-2             cluster_2.1.2         dbplyr_2.1.0          png_0.1-7             uwot_0.1.10           shiny_1.6.0          
# [29] sctransform_0.3.2     spatstat.sparse_2.0-0 compiler_4.0.5        httr_1.4.2            backports_1.2.1       assertthat_0.2.1      Matrix_1.3-2         
# [36] fastmap_1.1.0         lazyeval_0.2.2        cli_2.5.0             limma_3.46.0          later_1.1.0.1         htmltools_0.5.1.1     tools_4.0.5          
# [43] igraph_1.2.6          gtable_0.3.0          glue_1.4.2            RANN_2.6.1            reshape2_1.4.4        Rcpp_1.0.6            scattermore_0.7      
# [50] cellranger_1.1.0      vctrs_0.3.6           nlme_3.1-152          lmtest_0.9-38         globals_0.14.0        rvest_0.3.6           mime_0.10            
# [57] miniUI_0.1.1.1        lifecycle_1.0.0       irlba_2.3.3           goftest_1.2-2         future_1.21.0         MASS_7.3-53.1         zoo_1.8-8            
# [64] scales_1.1.1          spatstat.core_2.0-0   hms_1.0.0             promises_1.2.0.1      spatstat.utils_2.1-0  parallel_4.0.5        RColorBrewer_1.1-2   
# [71] reticulate_1.18       pbapply_1.4-3         gridExtra_2.3         rpart_4.1-15          stringi_1.5.3         rlang_0.4.10          pkgconfig_2.0.3      
# [78] matrixStats_0.58.0    lattice_0.20-41       ROCR_1.0-11           tensor_1.5            labeling_0.4.2        patchwork_1.1.1       htmlwidgets_1.5.3    
# [85] bit_4.0.4             tidyselect_1.1.0      parallelly_1.23.0     RcppAnnoy_0.0.18      plyr_1.8.6            R6_2.5.0              generics_0.1.0       
# [92] DBI_1.1.1             withr_2.4.1           pillar_1.4.7          haven_2.3.1           mgcv_1.8-34           fitdistrplus_1.1-3    survival_3.2-10      
# [99] abind_1.4-5           future.apply_1.7.0    hdf5r_1.3.3           modelr_0.1.8          crayon_1.4.1          KernSmooth_2.23-18    spatstat.geom_2.0-1  
# [106] plotly_4.9.3          grid_4.0.5            readxl_1.3.1          data.table_1.14.0     reprex_1.0.0          digest_0.6.27         xtable_1.8-4         
# [113] httpuv_1.5.5          munsell_0.5.0         viridisLite_0.3.0    
