...
##### /// Add additional filters for sensitivity analysis from Supplementary Fig 8 
neg_drops1 = md %>%
...
if (length(ns > 0)) {
  ...
  neg_prot1 = neg_prot1[!prot_names == ns, ]
  neg_prot2 = neg_prot2[!prot_names == ns, ]
  neg_prot3 = neg_prot3[!prot_names == ns, ]
  neg_prot4 = neg_prot4[!prot_names == ns, ]
} 
