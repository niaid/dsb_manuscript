...
# thresholds 
cellranger_cells = data.table::fread(input = here("data/10x_rds/5prime_5k/filtered_feature_bc_matrix/barcodes.tsv.gz"),header = FALSE)$V1
...
# savepaths 
figpath = paste0(here("V2/10x_analysis/figures/"), project_title, "/"); dir.create(figpath)
...
# define isotypes 
isotypes = rownames(pos_prot)[13:15]; isotypes
...
ggplot(dfplot, aes(x = CD3_TotalSeqC, y = CD19_TotalSeqC  )) + mgl
