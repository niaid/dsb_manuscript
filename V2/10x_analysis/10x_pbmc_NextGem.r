...
# thresholds 
cellranger_cells = data.table::fread(input = here("data/10x_rds/nextgem_5k/filtered_feature_bc_matrix/barcodes.tsv.gz"),header = FALSE)$V1
...
# read raw data
raw = readRDS(file = here("data/10x_rds/10x_pbmc5k_NextGem.rds"))
